...
DELIMITER $$
CREATE TRIGGER `chk_all_info_is_non_empty` BEFORE INSERT ON `activity_list` FOR EACH ROW BEGIN
DECLARE msg varchar(128);
if(new.name="") THEN
   set msg = 'Error: name can not be null.'; 
   signal sqlstate '45003' set message_text = msg;
end if;
IF(new.description ="") THEN
set msg = 'Error: Description can not be null.'; 
   signal sqlstate '45004' set message_text = msg;  
end if;
IF(new.status ="") THEN
set msg = 'Error: Status can not be null.'; 
...
(1, 'Adminstrator', NULL, 'Admin', 'admin', 'admin', 'uploads/avatar-1.png?v=1639468007', NULL, 1, 1, '2021-01-20 14:02:37', '2021-12-14 15:47:08'),
